...
readline.createInterface({ input: process.stdin }).on('line', line => {
  ...
  if (method === 'initialize') return send({ jsonrpc: '2.0', id, result: { protocolVersion: params.protocolVersion, agentCapabilities: { loadSession: true }, authMethods: [], agentInfo: { name: 'Dutydeck Mock ACP', version: '1.0.0' } } });
