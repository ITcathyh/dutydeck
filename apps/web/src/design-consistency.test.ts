...
/*
  ...
  如果只定义字号 token 而缺乏自动化约束，极易导致硬编码 px 散落各处——**token 没有
  强制力就只是愿望**。dutydeck 自身历史实现也有类似情况：`docs/interaction-design-2026-08-30.md`
  §7.3 明确规定「正文 14px、辅助文字不回退到 8–10px」，但重构前仍散落 90 处 10px、
  8 处 9px。规范写在文档里容易被遗漏，写成测试断言才拦得住。
