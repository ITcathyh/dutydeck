...
export async function createLarkManagementHarness(
  ...
  try {
    ...
    repositories = createRepositories(database, { mode: 'runtime', newDatabaseAuthority: 'ledger_v1' });
    ...
    runtime = new DutydeckRuntime(repositories, {
      ...
      authorizeExecution: (sessionId, actorId) => manager.prepareTurn(sessionId, actorId),
